...
VALUES (NULL , 'Petit Déjeuner en chambre', 'PDJ Continental', 25, 1, 3),
	   (NULL , 'Minibar', '2 paquets de snacks, eau plate et petillant, chocolat, vin blanc et mousseaux, gin et vodka', 85, 0, 3),
	   ...
	   (NULL , 'Scort Boy', 'Mission de 2 hr', 245, 0, 4),
	   (NULL , 'Resevation de voiture', 'Categorie a choisir par le client', 25, 0, 4);

INSERT INTO rooms
VALUES (NULL , 'Moscou', 28.5, 0, 1, 'Mer', 1, 225, 3, 3),
       (NULL , 'Paris', 18.5, 1, 1, 'Montagne', 0, 180.5, 1, 1),
       (NULL , 'Rio', 22.5, 0, 2, 'Mer', 1, 200, 2, 2),
       (NULL , 'Tokio', 15.7, 1, 2, 'Montagne', 0, 165.6, 1, 2),
       (NULL , 'Dublin', 25, 0, 3, 'Mer', 0, 215, 2, 3),
